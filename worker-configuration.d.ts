/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2d576fa1097944eb46518c7d3ad6e37)
// Runtime types generated with workerd@1.20260410.1 2025-11-18 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		DEBUG_I18N: string;
		DEMO_MODE: string;
		CLOUDFLARE_CACHEPURGE_API_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ZONE_ID" | "I18N_CACHE" | "DEBUG_I18N" | "DEMO_MODE" | "CLOUDFLARE_CACHEPURGE_API_TOKEN">> {}
}
